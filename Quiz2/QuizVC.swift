...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "img1", questionText: "which iron man suit was made to defeat HULK ?", options: ["Mark42", "HulkBuster", "Mark85", "Mark76"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "Real Name of Black Widow", options: ["May", "Shantabai", "steave", "Natasha Romanoff"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "img3", questionText: "who killed thanos?", options: ["spider man", "cpt america", "thor", "iron man"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "img4", questionText: "i love you -----", options: ["-3000", "0", "1000", "3000"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "img5", questionText: "Which Infinity stones Does Vision Had?", options: ["Mind Stone", "Soul Stone", "Time Stone", "Love Stone"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "img1", questionText: "What is the color of IRON Man?", options: ["Violet", "Yellow", "Red", "White"], correctAns: 2, wrongAns: -1, isAnswered: false)
